...
$(function () {
  ...
  function setFormData(entry, key) {
    ...
    for (var _i3 = 0; _i3 < entry.members.length; _i3++) {
      ...
      $("#member".concat(num, "-character")).val(entry.members[_i3].character);
      $("#member".concat(num, "-comment")).val(entry.members[_i3].comment);
      $("#member".concat(num, "-region")).val(entry.members[_i3].region);
      $("#member".concat(num, "-env")).val(entry.members[_i3].env);
