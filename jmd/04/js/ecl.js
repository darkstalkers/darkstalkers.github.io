...
EscapeSJIS = function EscapeSJIS(str) {
...
UnescapeSJIS = function UnescapeSJIS(str) {
...
EscapeEUCJP = function EscapeEUCJP(str) {
  return str.replace(/[^*+.-9A-Z_a-z-]/g, function (s) {
    var c = s.charCodeAt(0);
...
UnescapeEUCJP = function UnescapeEUCJP(str) {
...
EscapeJIS7 = function EscapeJIS7(str) {
...
UnescapeJIS7 = function UnescapeJIS7(str) {
  var i = 0,
      p,
      q,
      s = "",
...
EscapeJIS8 = function EscapeJIS8(str) {
  var u = String.fromCharCode,
...
UnescapeJIS8 = function UnescapeJIS8(str) {
  var i = 0,
      p,
      s = "",
...
EscapeUnicode = function EscapeUnicode(str) {
  return str.replace(/[^*+.-9A-Z_a-z-]/g, function (s) {
    var c = s.charCodeAt(0);
...
UnescapeUnicode = function UnescapeUnicode(str) {
  return str.replace(/%u[0-9A-F]{4}|%[0-9A-F]{2}/ig, function (s) {
    return String.fromCharCode("0x" + s.substring(s.length / 3));
  });
};

EscapeUTF7 = function EscapeUTF7(str) {
...
UnescapeUTF7 = function UnescapeUTF7(str) {
  var i = 0,
      B = {};
  while (i < 64) {
...
EscapeUTF8 = function EscapeUTF8(str) {
  return str.replace(/[^*+.-9A-Z_a-z-]/g, function (s) {
    var c = s.charCodeAt(0);
...
UnescapeUTF8 = function UnescapeUTF8(str) {
...
EscapeUTF16LE = function EscapeUTF16LE(str) {
  var H = function H(c) {
...
UnescapeUTF16LE = function UnescapeUTF16LE(str) {
  var u = String.fromCharCode,
...
GetEscapeCodeType = function GetEscapeCodeType(str) {
